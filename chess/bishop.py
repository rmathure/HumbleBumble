...
from diagonal_moving_piece import get_diagonal_moves
...
class Bishop(Piece):
    ...
    def get_possible_moves(self):
        self.__moves__ = get_diagonal_moves(self.board, self, self.get_posx(), self.get_posy())
        return self._literal_form_possible_moves_()

    def _literal_form_possible_moves_(self):
        moves_list = list()
        for move in self.__moves__:
            moves_list.append("Bishop at " + self.get_position() + " can move to " +
